...
A [very simple pipeline](.github/workflows/continuous-integration.yaml) that runs two jobs - Build and Run Tests - sequentially in a Github Workflow has been defined. It uses a Bazel cache.
